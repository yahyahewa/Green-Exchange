...
function leftAside({ name, donated, recived, img }) {
  img =
  ...
  return (
    <main className="flex flex-col md:grid md:grid-cols-12 gap-5">
      <article className=" col-span-4  flex flex-col items-start justify-center gap-y-4">
        <div className="border w-full   rounded-lg p-2 text-slate-600">
          ...
          <div className="flex  items-center justify-evenly">
            ...
            <div className="flex">
              <div className="flex flex-col border-r pr-2">
                <span className="text-center font-bold">{donated}</span>
                <span className="text-sm text-center">donated</span>
              </div>
              <div className="flex flex-col pl-2">
                <span className="text-center font-bold">{recived}</span>
                <span className="text-sm text-center">recived</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <NavLink
          to={'/create'}
          className="border hover:cursor-pointer hover:bg-green-400 transition-all border-green-500  w-[90%] rounded-lg p-2 text-slate-600 h-[100px]
        font-bold flex justify-center items-center"
        >
          Donate Item <i className="fa-solid fa-plus fa-lg ml-2"></i>
        </NavLink>
      </article>

      <section className="bg-blue-400 md:col-span-8 flex flex-col p-5 ">
        <div className="flex flex-col ">
          <h5 className="text-xs font-bold text-neutral-500">donated Items: </h5>
          <div className="flex ">
